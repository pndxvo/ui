...
local function MakeDraggable(topbarobject, object)
	...
	local function Update(input)
		...
		local Tween = TweenService:Create(object, TweenInfo.new(0), {Position = pos}) -- Smooth move ui
		Tween:Play()
	end
...
function lib:Create(time, size, hidekey)
	...
	PromptContainer.BackgroundColor3 = Color3.fromRGB(20, 20, 20)
	PromptContainer.BackgroundTransparency = 0.2
	...
	-- MainGlow.ImageColor3 = Color3.fromRGB(209, 0, 0)
	...
	PromptBackground.BackgroundColor3 = Color3.fromRGB(35, 35, 35)
	...
	PromptStroke.Color = Color3.fromRGB(35, 35, 35)
	...
	--PromptTitle.Text = "<font color='rgb(209, 0, 0)'><font size='20'>»</font></font>  " .. tostring(thetext)
	...
	PromptSepTop.BackgroundColor3 = Color3.fromRGB(35, 35, 35)
	...
	PromptSepBottom.BackgroundColor3 = Color3.fromRGB(35, 35, 35)
	...
	PromptYesButton.BackgroundColor3 = Color3.fromRGB(0, 190, 0) -- yes button
	...
	PromptNoButton.BackgroundColor3 = Color3.fromRGB(220, 40, 40) -- no button
	...
	PromptYesButton.MouseEnter:Connect(function()
		game.TweenService:Create(PromptYesButton, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {BackgroundColor3 = Color3.fromRGB(0, 150, 0)}):Play()
	end)

	PromptYesButton.MouseLeave:Connect(function()
		game.TweenService:Create(PromptYesButton, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {BackgroundColor3 = Color3.fromRGB(0, 190, 0)}):Play()
	end)

	PromptYesButton.MouseButton1Down:Connect(function()
		game.TweenService:Create(PromptYesButton, TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {BackgroundColor3 = Color3.fromRGB(0, 217, 0)}):Play()
	end)

	PromptYesButton.MouseButton1Up:Connect(function()
		game.TweenService:Create(PromptYesButton, TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {BackgroundColor3 = Color3.fromRGB(0, 190, 0)}):Play()
	end)

	PromptNoButton.MouseEnter:Connect(function()
		game.TweenService:Create(PromptNoButton, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {BackgroundColor3 = Color3.fromRGB(180, 40, 40)}):Play()
	end)

	PromptNoButton.MouseLeave:Connect(function()
		game.TweenService:Create(PromptNoButton, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {BackgroundColor3 = Color3.fromRGB(220, 40, 40)}):Play()
	end)

	PromptNoButton.MouseButton1Down:Connect(function()
		game.TweenService:Create(PromptNoButton, TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {BackgroundColor3 = Color3.fromRGB(255, 40, 40)}):Play()
	end)
	...
	LeftBarBack.BackgroundColor3 = Color3.fromRGB(15, 15, 15)
	...
	LeftBarBackCR.BackgroundColor3 = Color3.fromRGB(15, 15, 15)
	...
	LeftBarBackLine.BackgroundColor3 = Color3.fromRGB(15, 15, 15)
	...
	local xyzlogo = Instance.new("TextLabel") -- ImageLabel
	...
	xyzlogo.AnchorPoint = Vector2.new(0.5, 0)
	xyzlogo.BackgroundTransparency = 1.000
	xyzlogo.Position = UDim2.new(0.493750006, 0, 0.0207999982, 3)
	xyzlogo.Size = UDim2.new(0, 47, 0, 46)
	-- xyzlogo.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
	-- xyzlogo.Image = "rbxassetid://10272150497" -- LOGO
	...
	ProfileStroke.Color = Color3.fromRGB(255, 0, 0)
	...
	SearchBack.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
	...
	function tabs:Tab(title, AssID, desc1, desc2)
		...
		TabHighlight.BackgroundColor3 = Color3.fromRGB(255, 0, 0)
		...
		PageFade.BackgroundColor3 = Color3.fromRGB(20, 20, 20)
		...
		function subtabs:SubTab(title, AssID)
			...
			SubTabBtnOutline.BackgroundColor3 = Color3.fromRGB(209, 0, 0)
			...
			SubTabBtnInline.BackgroundColor3 = Color3.fromRGB(20, 20, 20)
			...
			SubTabBtnInteract.MouseEnter:Connect(function()
				TweenService:Create(SubTabBtnOutline, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {BackgroundColor3 = Color3.fromRGB(156, 0, 0)}):Play()
			end)

			SubTabBtnInteract.MouseLeave:Connect(function()
				TweenService:Create(SubTabBtnOutline, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {BackgroundColor3 = Color3.fromRGB(209, 0, 0)}):Play()
			end)

			SubTabBtnInteract.MouseButton1Down:Connect(function()
				TweenService:Create(SubTabBtnOutline, TweenInfo.new(0.075, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {BackgroundColor3 = Color3.fromRGB(94, 0, 0)}):Play()
			end)
			...
			SubPageFade.BackgroundColor3 = Color3.fromRGB(20, 20, 20)
			...
			SubTabBtnInteract.MouseButton1Click:Connect(function()
				...
				for i, v in next, AllSubTabBtns:GetDescendants() do
					if v.Name == 'SubTabBtnInline' then
						TweenService:Create(v, TweenInfo.new(lib.Animations.AnimSpeed, Enum.EasingStyle.Quad, Enum.EasingDirection.In), {BackgroundColor3 = Color3.fromRGB(20, 20, 20)}):Play()
					end
				end
				TweenService:Create(SubTabBtnInline, TweenInfo.new(lib.Animations.AnimSpeed, Enum.EasingStyle.Quad, Enum.EasingDirection.In), {BackgroundColor3 = Color3.fromRGB(209, 0, 0)}):Play()
			end)
			...
			function items:Label(side, text, image)
				...
				LabelArrows.Text = "»"
				LabelArrows.TextColor3 = Color3.fromRGB(209, 0, 0)
				LabelArrows.TextSize = 20
				LabelArrows.TextXAlignment = Enum.TextXAlignment.Left

				local LabelGradient = Instance.new("UIGradient")
				LabelGradient.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(46, 20, 20)), ColorSequenceKeypoint.new(0.08, Color3.fromRGB(56, 23, 23)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(110, 0, 0))}
			...
			function items:Toggle(side, text, config, callback)
				...
				Toggle.BorderColor3 = Color3.fromRGB(42, 42, 42)
				...
				ToggleFrameBack.BackgroundColor3 = Color3.fromRGB(33, 33, 33)
				...
				ToggleInteract.MouseButton1Click:Connect(function()
					if toggled == false then
						...
						TweenService:Create(ToggleFrameBack, TweenInfo.new(lib.Animations.ElementsAS, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {BackgroundColor3 = Color3.fromRGB(209, 0, 0)}):Play()
					else
						toggled = false
						...
						TweenService:Create(ToggleFrameBack, TweenInfo.new(lib.Animations.ElementsAS, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {BackgroundColor3 = Color3.fromRGB(33, 33, 33)}):Play()
					end
			...
			function items:CounterLabel(side, text, arrow)
				...
				if arrow then
					...
					CounterLabelArrows.TextColor3 = Color3.fromRGB(209, 0, 0)
			...
			function items:Colorpicker(side, text, preset, callback)
				...
				Title.BorderColor3 = Color3.fromRGB(42, 42, 42)
			...
			function items:Button(side, text, callback, callback_2, prompttitle, promptmessage)
				...
				ButtonOutline.Color = Color3.fromRGB(26, 26, 26)
				...
				ButtonUIStroke.Color = Color3.fromRGB(121, 121, 121)
				...
				ButtonFrame.MouseEnter:Connect(function()
					TweenService:Create(ButtonFrame, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {BackgroundColor3 = Color3.fromRGB(34, 34, 34)}):Play()
					TweenService:Create(ButtonUIStroke, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {Color = Color3.fromRGB(200, 200, 200)}):Play()
				end)

				ButtonFrame.MouseLeave:Connect(function()
					TweenService:Create(ButtonFrame, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {BackgroundColor3 = Color3.fromRGB(43, 43, 43)}):Play()
					TweenService:Create(ButtonUIStroke, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {Color = Color3.fromRGB(121, 121, 121)}):Play()
				end)

				ButtonFrame.MouseButton1Down:Connect(function()
					TweenService:Create(ButtonFrame, TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {BackgroundColor3 = Color3.fromRGB(27, 27, 27)}):Play()
				end)

				ButtonFrame.MouseButton1Up:Connect(function()
					TweenService:Create(ButtonFrame, TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {BackgroundColor3 = Color3.fromRGB(34, 34, 34)}):Play()
				end)
			...
			function items:Bind(side, text, mode, callback)
				...
				BindContainer.BorderColor3 = Color3.fromRGB(43, 43, 43)
				...
				BindOutline.Color = Color3.fromRGB(60, 60, 60)
				...
				KeybindFrame.BackgroundColor3 = Color3.fromRGB(43, 43, 43)
				...
				KeybindFrameStroke.Color = Color3.fromRGB(60, 60, 60)
			...
			function items:Textbox(side, text, placeholdertext, clearafter, callback)
				...
				TextBoxContainer.BorderColor3 = Color3.fromRGB(42, 42, 42)
				...
				TextBoxOutline.Color = Color3.fromRGB(26, 26, 26)
				...
				TextBoxFrame.Size = UDim2.new(0, 115, 0, 19)  -- adsamdpasmnfpandspfnpdksfnpdsnfpdspfndps
				...
				Textbox.Focused:Connect(function()
					TextBoxFrame:TweenSize(UDim2.new(0, 155, 0, 19),Enum.EasingDirection.Out,Enum.EasingStyle.Quart,0.1,true)
				...
				TextBoxFrame.MouseLeave:Connect(function()
					TweenService:Create(TextboxUIStroke, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {Color = Color3.fromRGB(121, 121, 121)}):Play()
				end)
			...
			function items:Slider(side, text, start, min, max, inc, callback)
				...
				Slider.BorderColor3 = Color3.fromRGB(42, 42, 42)
				...
				SlideBack.BackgroundColor3 = Color3.fromRGB(33, 33, 33)
				...
				SlideBackLight.BackgroundColor3 = Color3.fromRGB(209, 0, 0)
				...
				SliderValue.BackgroundColor3 = Color3.fromRGB(43, 43, 43)
				...
				SliderValStroke.Color = Color3.fromRGB(60, 60, 60)
			...
			function items:Dropdown(side, text, default, options, cb, multi)
				...
				DropdownOutline.Color = Color3.fromRGB(42, 42, 42)
				...
				DropdownDropFrame.BackgroundColor3 = Color3.fromRGB(42, 42, 42)
				...
				DropdownInteract.BorderColor3 = Color3.fromRGB(42, 42, 42)
				...
				DropdownDropFrameArrowHolder.BackgroundColor3 = Color3.fromRGB(60, 60, 60)
				...
				DropdownChildFrameOutline.BackgroundColor3 = Color3.fromRGB(209, 209, 209)
				...
				DropdownChildFrame.BackgroundColor3 = Color3.fromRGB(33, 33, 33)
				...
				DropdownChildFrameScroll.BackgroundColor3 = Color3.fromRGB(33, 33, 33)
				...
				DropdownInteract.MouseEnter:Connect(function()
					TweenService:Create(DropdownDropFrame, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {BackgroundColor3 = Color3.fromRGB(45, 45, 45)}):Play()
				end)
				DropdownInteract.MouseLeave:Connect(function()
					TweenService:Create(DropdownDropFrame, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {BackgroundColor3 = Color3.fromRGB(34, 34, 34)}):Play()
				end)
				...
				for _, opt in next, options do
					...
					DropdownBtn.BackgroundColor3 = Color3.fromRGB(33, 33, 33)
					...
					DropdownBtn.MouseEnter:Connect(function()
						TweenService:Create(DropdownBtn, TweenInfo.new(0, Enum.EasingStyle.Quad, Enum.EasingDirection.In), {BackgroundColor3 = Color3.fromRGB(80, 80, 80)}):Play()
					end)
					DropdownBtn.MouseLeave:Connect(function()
						TweenService:Create(DropdownBtn, TweenInfo.new(0, Enum.EasingStyle.Quad, Enum.EasingDirection.In), {BackgroundColor3 = Color3.fromRGB(33, 33, 33)}):Play()
					end)
				end
...
function lib:Notify(title, desc, dur)
	...
	NotificationBack.BackgroundColor3 = Color3.fromRGB(20, 20, 20)
	...
	NotificationLine.BackgroundColor3 = Color3.fromRGB(120, 0, 0)
	...
	NotificationDurationLine.BackgroundColor3 = Color3.fromRGB(255, 0, 0)
	...
	-- NotificationGlow.ImageColor3 = Color3.fromRGB(209, 0, 0)
